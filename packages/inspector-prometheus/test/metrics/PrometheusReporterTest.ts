...
export class PrometheusReporterTest {
  ...
  @test
  public async 'reporting with no MetricRegistries added'(): Promise<void> {
    this.reporter.removeMetricRegistry(this.registry)
    expect(await this.reporter.getMetricsString()).to.be.equal('\n')
  }

  @test
  public async 'reporting with a single MetricRegistry added, that is empty'(): Promise<void> {
    expect(await this.reporter.getMetricsString()).to.be.equal('')
  }

  @test
  public async 'check existence of all monotone counter'(): Promise<void> {
  ...
  @test
  public async 'check existence of all counter fields'(): Promise<void> {
  ...
  @test
  public async 'check existence of all gauge fields'(): Promise<void> {
  ...
  @test
  public async 'check existence of all histogram fields'(): Promise<void> {
  ...
  @test
  public async 'check existence of all meter fields'(): Promise<void> {
  ...
  @test
  public async 'check existence of all timer fields'(): Promise<void> {
  ...
  @test
  public async 'check mixed metrics: no tags, no timestamp, no description'(): Promise<void> {
  ...
  @test
  public async 'check mixed metrics with timestamp'(): Promise<void> {
    this.clock.setCurrentTime({ milliseconds: 0, nanoseconds: 0 })
    this.reporter = new PrometheusMetricReporter({
      clock: this.clock,
  ...
  @test
  public async 'check mixed metrics with description'(): Promise<void> {
  ...
  @test
  public async 'check mixed metrics with tags'(): Promise<void> {
  ...
  @test
  public async 'check mixed metrics without comments'(): Promise<void> {
    let taggable: Taggable = null
  ...
  @test
  public async 'check mixed metrics as untyped'(): Promise<void> {
    this.reporter = new PrometheusMetricReporter({
      clock: this.clock,
      emitComments: true,
      includeTimestamp: false,
  ...
  @test
  public async 'check tag name compatibility'(): Promise<void> {
  ...
  @test
  public async 'check metric name compatibility'(): Promise<void> {
    this.reporter = new PrometheusMetricReporter({
      emitComments: false,
      includeTimestamp: false,
      useUntyped: false
  ...
  public async 'check event reporting'(): Promise<void> {
    ...
    this.reporter = new PrometheusMetricReporter({}).setTags(tags)
    ...
    expect(await this.reporter.getEventString(event)).to.be.equal(
