...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    <ul class="list">
        <li class="title">
            <a href="index.html" data-type="index-link">inspector-prometheus documentation</a>
        </li>
        <li class="divider"></li>
...
` : '' }
        ...
        <li class="chapter">
            ...
            ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                    ...
                    <li class="link">
                        <a href="classes/PrometheusReporterOptions.html" data-type="entity-link">PrometheusReporterOptions</a>
                    </li>
                    <li class="link">
                        <a href="classes/PushgatewayMetricReporter.html" data-type="entity-link">PushgatewayMetricReporter</a>
                    </li>
                    <li class="link">
                        <a href="classes/PushgatewayReporterOptions.html" data-type="entity-link">PushgatewayReporterOptions</a>
                    </li>
            </ul>
        </li>
        <li class="chapter">
