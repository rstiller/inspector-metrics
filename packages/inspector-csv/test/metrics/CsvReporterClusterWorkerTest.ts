...
export class CsvReporterClusterWorkerTest extends AbstractReportTest {
    ...
    @test
    public async "check if metrics are serialized and send to master"() {
    ...
    @test
    public async "check if events are serialized and send to master"() {
    ...
    @test
    public async "check if writer.init is not called"() {
