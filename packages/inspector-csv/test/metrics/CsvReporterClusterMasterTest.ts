...
export class CsvReporterClusterMasterTest extends AbstractReportTest {
    ...
    @test
    public async "check if report message is processed even if reporter is not started"() {
    ...
    @test
    public async "check if report message is processed if reporter is started"() {
