...
export class MetricsSupport {
    ...
    public constructor() {
        ...
        this.reporter = new ElasticsearchMetricReporter({
            clientOptions,
            indexnameDeterminator: ElasticsearchMetricReporter.dailyIndex("metric-elasticsearch-6"),
            log: null,
    ...
    public async reportEvent(event: Event<any>) {
        return this.reporter.reportEvent(event);
    }
